...
{
    /// <summary>
    /// Standard medal calculation for Duell competitions.
    /// Uses ONLY percentage-based placement medals (top 1/9 Silver, top 1/3 Bronze).
    /// No fixed-score thresholds are applied (unlike Precision and Milsnabb).
    /// </summary>
    public class DuellStandardMedalService
    {
        /// <summary>
        /// Calculate standard medals for Duell shooters.
